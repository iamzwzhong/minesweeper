...
const Leaderboards = () => {
  ...
  const currentLeaderboardEntries = leaderboardEntries.slice(
    pagesVisited,
    pagesVisited + leaderboardEntriesPerPage
  );
  const pageCount = Math.ceil(
    leaderboardEntries.length / leaderboardEntriesPerPage
  );
  ...
  return (
    <div className="leaderboardsOuterContainer">
      <Link to={`/`}>
        <button className="button btn-margin def" type="submit">
          Menu
        </button>
      </Link>
      <div className="buttonSelectors">
        <button
          className="l_button btn-margin beg"
          type="submit"
        ...
        <button
          className="l_button btn-margin int"
          type="submit"
          onClick={toggleIntermediate}
        >
          Intermediate
        </button>
        <button
          className="l_button btn-margin exp"
          type="submit"
